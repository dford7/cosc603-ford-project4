...
public class VendingMachine {
	...
	// Error message for amounts < 0
	private static final String INVALID_BALANCE_MESSAGE = "Invalid balance.  Balance must be >= 0";
	 ...
	 * Postcondition: If the code slot is not empty, 
	 * the item in that slot is removed.
	 * @param code The code eg. "A" of the item in the vending machine
	 * @return The item occupying the slot with the given code.
	 * @throws VendingMachineException If the slot at 
	 * the specified code is empty and if the code is invalid
	 */
	 ...
	 * Note that this simply returns the amount 
	 * and does not actually give back the change to the user.
	 * Precondition: balance >= 0; 
	 * Note that the vending machine should start with a 0 balance.
	 * Postcondition: the balance is >= 0 
	 * and remains the same as it was before the function was called.
